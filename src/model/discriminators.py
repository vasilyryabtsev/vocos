...
class MultiPeriodDiscriminator(nn.Module):
    """
    Multi-Period Discriminator module.

    Args:
        periods (tuple[int]): Tuple of periods for each discriminator.
        num_embeddings (int, optional): Number of embeddings. 
            None means non-conditional discriminator.
    """
...
class MultiResolutionDiscriminator(nn.Module):
    """
    Multi-Resolution Discriminator module.

    Args:
        fft_sizes (tuple[int]): Tuple of window lengths for FFT. 
